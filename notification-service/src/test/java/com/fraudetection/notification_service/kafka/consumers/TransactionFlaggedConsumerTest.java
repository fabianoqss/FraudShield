...
@SpringBootTest
@EmbeddedKafka(partitions = 1, topics = {"transaction.flagged", "transaction.flagged-dlt"},
        bootstrapServersProperty = "spring.kafka.bootstrap-servers")
@Testcontainers
class TransactionFlaggedConsumerTest {
    ...
    @Test
    void consumirEventoTransactionFlagged_shouldNotificar_whenEventoAindaNaoFoiProcessado() {
    ...
    @Test
    void consumirEventoTransactionFlagged_shouldIgnorarProcessamento_whenEventoJaFoiProcessado() {
        UUID eventId = UUID.randomUUID();
    ...
    private KafkaEventEnvelope buildEnvelope(UUID eventId) {
        ...
        return new KafkaEventEnvelope(eventId, "TRANSACTION_FLAGGED", Instant.now(), payload);
    }
}
