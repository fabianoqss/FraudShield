package com.fraudetection.ledger_service.api.handler;
...
import com.fraudetection.ledger_service.shared.dto.exception.AccountServiceUnavailableException;
import com.fraudetection.ledger_service.shared.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAccountServiceUnavailable(AccountServiceUnavailableException ex, HttpServletRequest request) {
        log.error("Account service call failed on {}: {}", request.getRequestURI(), ex.getMessage());
